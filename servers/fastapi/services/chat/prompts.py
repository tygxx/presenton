...
def build_system_prompt(
    ...
    return (
        ...
        "- Asset search terms must be English: any icon/image search query (icon_query, __icon_query__, query fields) and any "
        "image prompt (__image_prompt__) must be written as English noun phrases, even when the slide's title/body content is in "
        "another language (e.g. Chinese), so they match the English icon/image asset libraries. Keep visible slide text in the user's language.\n"
